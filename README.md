...
Save a photo of yourself as `img/gavin.jpg` (same folder as the HTML files, in an `img` subfolder) and it will automatically appear:
- large and centered at the top of the homepage
- small and circular in the nav bar, replacing the "GR" placeholder

No code changes needed — just add the file with that exact name. Until you add it, a placeholder is shown instead.
